...
$app->post('/respuesta',	function () use ($app){
	...
	$params = array (
		...
		'id_pregunta'	=> isset($body->id_pregunta)?$body->id_pregunta:'',
		'valor_respuesta'	=> $body->valor_respuesta,
			);

	$obj = makeQuery("INSERT INTO respuesta (_id, id_estudiante, id_pregunta, valor_respuesta )  VALUES ( null, :id_estudiante, :id_pregunta, :valor_respuesta   )", $params, false);
...
$app->post('/respuesta/:id',	function ($id) use ($app){
	...
	$obj = makeQuery("UPDATE respuesta SET  id_estudiante = :id_estudiante,  id_pregunta = :id_pregunta,  valor_respuesta = :valor_respuesta   WHERE _id = :id LIMIT 1", $params, false);
