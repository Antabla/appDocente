...
function getConnection() {
	...
	global $db_appDocente_db_Url, $db_appDocente_db_User, $db_appDocente_db_Pass, $db_appDocente_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_appDocente_db_Url.";dbname=".$db_appDocente_db_DbName, $db_appDocente_db_User, $db_appDocente_db_Pass);
